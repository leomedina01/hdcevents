...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="{{ route('events.update', ['id' => $event->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img src="{{ url('/') }}/img/events/{{ $event->image }}" alt="{{ $event->title }}" class="img-preview">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control" placeholder="What's going on this event?">{{ $event->description }}</textarea>
        </div>
        <div class="form-group">
